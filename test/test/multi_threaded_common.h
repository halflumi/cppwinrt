...
#pragma region iterator wrapper
    ...
    struct concurrency_checked_random_access_iterator : Iterator
    {
        ...
        concurrency_checked_random_access_iterator(concurrency_checked_random_access_iterator<container, ConvertibleFrom> const& other) : owner(other.owner), iterator(other.inner()) { }
